...
# Data
data_ademe_vae <- read_excel(here("Data brut","data ademe vae_baseline.xlsx"))
...
ademe_velo_marche_no_BAU_age_2030 <- ademe_velo_marche_no_BAU_age %>%
  filter(year == "2030")
ademe_velo_marche_no_BAU_age_2035 <- ademe_velo_marche_no_BAU_age %>%
  filter(year == "2035")
ademe_velo_marche_no_BAU_age_2040 <- ademe_velo_marche_no_BAU_age %>%
  filter(year == "2040")
ademe_velo_marche_no_BAU_age_2050 <- ademe_velo_marche_no_BAU_age %>%
  filter(year == "2050")

ademe_lifexp_no_BAU_age_2030 <- ademe_lifex_no_BAU_age %>%
  filter(year == "2030")
...
# Death
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2030$diff_death), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2030$diff_death_low), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2030$diff_death_high), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
...
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2040$diff_death), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2040$diff_death_low), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
aggregate(list("Nb of  Deaths" = ademe_velo_marche_no_BAU_age_2040$diff_death_high), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
...
# YLL
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2030$yll_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2030$yll_low_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2030$yll_high_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
...
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2040$yll_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2040$yll_low_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
aggregate(list("YLL" = ademe_velo_marche_no_BAU_age_2040$yll_high_corr), list("Scenario" = ademe_velo_marche_no_BAU_age_2040$scenario), sum)
...
# Cout
# 2030
aggregate(list("costs avoided" = ademe_velo_marche_no_BAU_age_2030$cout), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("costs avoided" = ademe_velo_marche_no_BAU_age_2030$cout_low), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
aggregate(list("costs avoided" = ademe_velo_marche_no_BAU_age_2030$cout_high), list("Scenario" = ademe_velo_marche_no_BAU_age_2030$scenario), sum)
...
d1.4 = ademe_velo_marche_no_BAU_age_2030 %>%
  group_by(scenario) %>%
  ...
  scale_y_continuous(labels = scales::comma, name = "Décès prévenues", limits =  c(-4500,45000))  +
  xlab("")+
...
d1.2 = ademe_velo_marche_no_BAU_age_2030 %>%
  group_by(scenario) %>%
...
l1 = ademe_lifexp_no_BAU_age_2030 %>%
  group_by(scenario) %>%
  ...
  ylab("Gain d'espérance de vie (mois)") + 
  xlab("")+
  theme(axis.text = element_text(size = 15))+
  scale_fill_manual(values=c("#56B4E9", "#CC79A7", "#009E73", "#D55E00"), name = "") +
  geom_hline(aes(yintercept = 0), color= "black", linetype = "solid")+
...
Figure_4_baseline = ggarrange(d1.4,d1.5,l1, l2,d1.2,d1.3,  ncol = 2 , nrow = 3, common.legend = TRUE, legend = "bottom",
                     labels = c("A: 2030","B: 2050"," C:2030","D: 2050","E: 2030","F: 2050"), hjust = -1.4, align = "v")

Figure_4_baseline

ggsave(here("figures","Figure_4_baseline.png"), plot = Figure_4_baseline, width=10, height=9)
